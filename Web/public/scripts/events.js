class Events {
  constructor() {
    if(location.pathname.endsWith("car.html")) {
      this.table = new AuctioneerTable("car");
...
Events.URL_HIST = 'http://3.229.134.85:3000/api/system/historian';
Events.URL_TRADE = 'ws://3.229.134.85:3000';
let app = new Events();